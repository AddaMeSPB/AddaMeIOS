...
extension EventClient {
  ...
  public static let happyPath = Self(
        ...
        EventResponse(
          items: [
            .init(
              ...
              coordinates: [60.020532228306031, 30.388014239849944], createdAt: Date(),
              updatedAt: Date()),
            .init(
              ...
              addressName: "8к1литД улица Вавиловых , Saint Petersburg", type: "Point",
              sponsored: false, overlay: false,
              coordinates: [60.020525506753494, 30.387988546891499], createdAt: Date(),
              updatedAt: Date()),
            .init(
              ...
              sponsored: false, overlay: false,
              coordinates: [60.00380571585201, 30.399472870547118], createdAt: Date(),
              updatedAt: Date()),
            .init(
              id: "5fbea245b226053f0ece711c", name: "Walk Around 🚶🏽🚶🏼‍♀️",
              ...
              coordinates: [60.261340452875721, 29.873706166262373], createdAt: Date(),
              updatedAt: Date()),
          ],
    ...
    create: { _, _ in
      Just(
        Event(
          id: "5fb1510012de9980bd0c2efc", name: "Testing data", details: "Waitting for details",
          imageUrl:
            "https://avatars.mds.yandex.net/get-pdb/2776508/af73774d-7409-4e73-81c8-c8ab127c2f8b/s1200?webp=false",
          duration: 14400, categories: "General", isActive: true,
          addressName: "8к1литД улица Вавиловых , Saint Petersburg", type: .Point, sponsored: false,
          overlay: false, coordinates: [60.020532228306031, 30.388014239849944])
      )
      .setFailureType(to: HTTPError.self)
      .eraseToAnyPublisher()
    }
