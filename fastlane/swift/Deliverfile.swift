...
public class Deliverfile: DeliverfileProtocol {
  ...
  public let username = "saroarkhandoker@yahoo.com"
  public let appIdentifier = "com.addame.AddaMeIOS"
  public let languages: [String]? = ["en-US"]
  public let screenshotsPath: String? = "./fastlane/screenshots"
}
