...
public final class CoreDataClient {
  ...
  public func getContacts() -> AnyPublisher<[Contact], HTTPRequest.HRError> {
    return contactClient.buidContacts()
      .removeDuplicates()
      .mapError {
        return HTTPRequest.HRError.custom("ContactEntity Fetch data error ", $0)
      }
      .flatMap { contacts in
  ...
  public func registerContacts(contacts: [Contact]) -> AnyPublisher<[Contact], HTTPRequest.HRError> {
    var results = [Contact]()
  ...
  //  public func fetchContactEntityThenConvertToContacts() -> AnyPublisher<[Contact], HTTPRequest.HRError> {
